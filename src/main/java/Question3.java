...
public class Question3 {
	//static String exePath = "C:\\Users\\chand\\Downloads\\chromedriver_win32\\chromedriver.exe";  
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		Thread.sleep(1000);
		List<WebElement> studios = driver.findElements(By.cssSelector(".container-3SE46"));
		Thread.sleep(500);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".linkContainer-1NkqM")));
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".linkContainer-1NkqM")));
		WebElement titleWebElement = studios.get(0).findElement(By.cssSelector(".linkContainer-1NkqM"));
		WebElement titleWebElement1 = studios.get(0).findElement(By.cssSelector(".linkContainer-1NkqM"));
		String title1 = titleWebElement.getText();
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".distance-OhP63")));
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".distance-OhP63")));
		String distance = studios.get(0).findElement(By.cssSelector(".distance-OhP63")).getText();
		String distance1 = studios.get(0).findElement(By.cssSelector(".distance-OhP63")).getText();
		WebElement element = driver.findElement(By.cssSelector(".input.input-3TfT5"));
		...
		List<WebElement> week = driver.findElements(By.cssSelector(".day-CZkDC"));
		for (int i = 0; i <= week.size(); i++) 
		{
			...
			if (i == dayOfWeek) 
			{
				...
				//String todayDay = week.get(i).findElement(By.cssSelector("div.dayName-CTNC6")).getText();
	...
	static String printMeetings(String DayOfWeek)
	{
		 ...
		 * driver.get("https://www.weightwatchers.com/us/"); driver.findElement(By
		 * .xpath("//span[(@class='MenuItem_menu-item__inner-wrapper__1trJ0')]/span[contains(text(), 'Attend')]"
		 * )) .click(); //clicks the Attend icon at the top right corner
		 * //Thread.sleep(1000); driver.findElement(By.xpath(
		 * "//span[@class='MenuItem_subtitle__3LoiE']/span[contains(text(),'Workshops')]"
		 * )) .click(); //clicks the Unlimited Workshops option //Thread.sleep(1000);
		 * driver.findElement(By.xpath("//span[contains(text(), 'Studio')]")).click();
		 * driver.findElement(By.xpath("//input[@id='location-search']")).sendKeys(
		 * "10011");
		 * driver.findElement(By.xpath("//button[@id='location-search-cta']")).click();
		 * //Thread.sleep(1000); // This will scroll the page till the bottom of the
		 * page JavascriptExecutor js = (JavascriptExecutor) driver;
		 * js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		 * List<WebElement> studios =
		 * driver.findElements(By.xpath("//div[@class='container-3SE46']")); WebElement
		 * titleWebElement =
		 * studios.get(0).findElement(By.cssSelector(".linkUnderline-1_h4g"));
		 * WebElement element =
		 * driver.findElement(By.xpath("//input[@class='input input-3TfT5']"));
		 * js.executeScript("arguments[0].scrollIntoView();", element);
		 * titleWebElement.click();
		 */
		//String exePath = "C:\\Users\\chand\\Downloads\\chromedriver_win32\\chromedriver.exe"; 
